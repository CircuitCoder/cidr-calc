...
export interface InitOutput {
  ...
  readonly __wbg_evalstate_free: (a: number, b: number) => void;
  readonly create_state: () => number;
  readonly print_scope: (a: number) => [number, number];
  readonly eval_input: (a: number, b: number, c: number) => [number, number, number, number];
